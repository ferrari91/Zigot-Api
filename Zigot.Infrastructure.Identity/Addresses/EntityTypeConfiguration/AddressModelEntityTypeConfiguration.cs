...
namespace Zigot.Infrastructure.Identity.Addresses.EntityTypeConfiguration
{
    public class AddressModelEntityTypeConfiguration : IEntityTypeConfiguration<Core.Domain.Contract.Addresses.Address>
    {
        public void Configure(EntityTypeBuilder<Core.Domain.Contract.Addresses.Address> builder)
        {
